...
export function Desktop() {
  ...
  return (
    <main id="desktop" className="relative h-[100dvh] min-h-[640px] overflow-hidden text-white">
      ...
      />
      <section
        className="relative z-10 h-full overflow-y-auto px-5 pb-32 pt-14 sm:px-8 md:overflow-hidden md:px-0"
        aria-label="Desktop icons"
        onClick={() => setSelectedIconId(null)}
      >
        <div className="grid grid-cols-1 gap-9 sm:grid-cols-2 sm:gap-x-7 sm:gap-y-10 md:block md:h-full">
          {desktopIcons
            .slice()
